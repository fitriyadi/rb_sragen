<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page">Filter Pembayaran</li>
    </ol>
</nav>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Pilih Periode Pembayaran</h6>

                <form class="forms-sample" action="?hal=laporan/lap-bayar" method="POST" enctype="multipart/form-data">
