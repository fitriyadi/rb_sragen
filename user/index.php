    ...
    <div class="site-section py-5 bg-warning">
      <div class="container">
        <div class="row justify-content-center">
          ...
          <h2 class="text-white m-0">Belajar dengan gembira bersama kami</h2>
          <a href="pendaftaran.php" class="btn btn-primary btn-custom-1 py-3 px-5 ml-auto">Mulai Daftar</a>
          </div>
        </div>
      </div>
    </div>
