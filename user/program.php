      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <span class="text-cursive h5 text-red d-block">Pebawaran Paket Program</span>
            <h2 class="text-white">Program Unggulan Kami</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              ...
              <h3 class="text-teal">MAPEL SD</h3>
              <p>1 kelompok maks 10 siswa
1 minggu 3x pertemuan (@90 menit)
Gratis Konsultasi PR

</p>
              <p><a href="#" class="btn btn-success btn-custom-1 mt-4">Detail</a></p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="images/flaticon/svg/002-target.svg" alt="Image" class="img-fluid"></span>
              <h3 class="text-success">BTA (Baca Tulis Al-Qur'an)</h3>
              <p>1 kelompok maks 5 siswa
...
Fun Learning & Games
          ...
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              ...
              <h3 class="text-danger">TK-SD</h3>
              <p>1 Tutor 1 Siswa <br>
Materi bisa memilih sesuai kebutuhan yang dibutuhkan
</p>
              <p><a href="#" class="btn btn-success btn-custom-1 mt-4">Detail</a></p>
            </div>
          </div>
